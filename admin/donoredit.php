...
<body>
    ...
    <div class="mid">
        <div class="wrapper">
            ...
            <?php
                    ...
                    ?>
                <header>Edit Donor Profile</header>
                <form action="#" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="field input">
                        <label>Last Donated On</label>
                        <input type="text" name="l_date" value="<?php echo $row['l_date']?>" required>
                    </div>
                    <div class="field input" >
                        <label>User ID</label>
    ...
    <script src="JavaScript/updatedonor.js"></script>
</body>
